...
<div class="max-w-md mx-auto space-y-5">
    ...
    <div class="card p-6">
        ...
        <div class="space-y-3 text-sm">
            ...
            <div class="flex justify-between">
                ...
                <span class="font-semibold"><?php echo e($subscription->duration_months); ?> Month(s)</span>
            </div>
            <div class="flex justify-between">
                <span class="text-gray-500">Payment Method</span>
                <span class="font-semibold"><?php echo e(ucfirst($subscription->payment_method)); ?></span>
            </div>
            <div class="border-t border-gray-100 pt-3 flex justify-between text-base">
                <span class="font-bold text-gray-900">Total</span>
                <span class="font-bold text-gray-900">৳<?php echo e(number_format($subscription->amount_bdt)); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="card p-6 bg-yellow-50 border-yellow-200">
        <div class="flex items-start gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-xs text-yellow-700 mt-0.5">
                    ...
                    <?php echo e(ucfirst($subscription->payment_method)); ?>'s real payment gateway.
        ...
        <div class="bg-white rounded-xl border border-yellow-200 p-5 space-y-3 mb-4">
            <?php if($subscription->payment_method === 'sslcommerz'): ?>
            ...
            <?php else: ?>
            <p class="text-xs font-bold text-gray-500 uppercase"><?php echo e(ucfirst($subscription->payment_method)); ?> Number (Demo)</p>
        ...
        <a href="<?php echo e(route('student.subscription.success', $subscription)); ?>"
           class="block w-full text-center py-3 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-colors">
            ✓ Confirm Payment — ৳<?php echo e(number_format($subscription->amount_bdt)); ?>

        </a>
    </div>

    <div class="flex justify-center">
        <a href="<?php echo e(route('student.subscription.cancel', $subscription)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\scholarify\resources\views/student/subscription/pay.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <div class="flex justify-between items-center mb-1">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-blue-600 hover:underline">Forgot?</a>
                    <?php endif; ?>
                </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-blue-600 font-medium hover:underline">Create one</a>
        </p>
    </div>
...
<?php /**PATH D:\scholarify\resources\views/auth/login.blade.php ENDPATH**/ ?>